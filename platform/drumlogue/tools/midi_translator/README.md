...
| [`pico/`](pico/) | Pico (RP2040/RP2350) firmware — the microcontroller port. Translation logic is host-tested; **USB/DIN transport is paused pending a decision** — see [`pico/STATUS.md`](pico/STATUS.md). |
