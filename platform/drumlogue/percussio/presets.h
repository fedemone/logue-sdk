...
static const char* const kModelName[kNumMethods][4] = {
    {"OnePole", "TwoPole", "OneZero", ""},   // subtract-op / -pp / -oz
    {"Pure", "NseFlr", "NsyFrq", "TunedNs"}, // add-freqs / :noise-amp / add-noisy-freqs / add-noise
...
//  Meth Modl Decay Level | Atk Hold Curv Tune | Coef Reso Freq NsRt
//  Ratio Idx1 Idx2 MDcy  | Bank Part NsAm Rand | Blnd Len Dens Grn
//
// Level/Attack/Hold/NsAm are tenths of a percent (400 = 40.0%), Reso and Blend
// hundredths (9900 = 99.00%), Ratio thousandths (1400 = 1.400), Index1/Index2
// hundredths (250 = 2.50).

static const Preset kPresets[] = {
    // ---- Subtractive: drum-subtract.ins --------------------------------
    // (subtract-op 0 .2 .4 '(0 0 5 1 100 0) :b1 0.9 :amp-env-base 10)
    {"BrshSnr1", {0, 0, 200, 400, 50, 50, 5, 0, 90, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-op 0 .5 .6 '(0 0 5 1 100 0) :b1 0.9 :amp-env-base 1000)
    {"BrshSnr2", {0, 0, 500, 600, 50, 50, 7, 0, 90, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-op 0 1 .6 '(0 0 2 1 100 0) :b1 0.9 :amp-env-base 100000)
    {"BrshSnr3", {0, 0, 1000, 600, 20, 20, 9, 0, 90, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-oz 0 .25 .4 '(0 0 5 1 100 0) :a1 -0.5 :amp-env-base 10)
    {"BrshSnr4", {0, 2, 250, 400, 50, 50, 5, 0, -50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-oz 0 .5 .6 '(0 0 5 1 100 0) :a1 -0.5 :amp-env-base 1000)
    {"BrshSnr5", {0, 2, 500, 600, 50, 50, 7, 0, -50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-op 0 .2 .3 '(0 1 100 0) :b1 0.2 :amp-env-base 100)
    {"SnareOP", {0, 0, 200, 300, 0, 0, 6, 0, 20, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                 5000, 1741, 20, 100}},
    // (subtract-oz 0 .2 .3 '(0 1 100 0) :a1 -0.2 :amp-env-base 100)
    {"SnareOZ", {0, 2, 200, 300, 0, 0, 6, 0, -20, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                 5000, 1741, 20, 100}},
    // (subtract-op 0 .2 .3 '(0 1 100 0) :b1 -0.2 :amp-env-base 100)  -- low-pass
    {"SnareLoP", {0, 0, 200, 300, 0, 0, 6, 0, -20, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-oz 0 .2 .3 '(0 1 100 0) :a1 0.2 :amp-env-base 100)   -- low-pass
    {"SnareLoZ", {0, 2, 200, 300, 0, 0, 6, 0, 20, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-pp 0 .2 .2 '(0 1 100 0) :r 0.2 :frequency 400)
    {"SnarePP", {0, 1, 200, 200, 0, 0, 5, 0, 50, 2000, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                 5000, 1741, 20, 100}},
    // (subtract-pp 0 .5 .02 '(0 0 5 1 100 0) :r .9 :frequency 100 :amp-env-base 1000)
    {"NsyBass1", {0, 1, 500, 600, 50, 50, 7, 0, 50, 9000, 100, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-pp 0 .5 .002 '(0 1 10 1 100 0) :r .99 :frequency 100 :amp-env-base 1000)
    {"NsyBass2", {0, 1, 500, 600, 0, 100, 7, 0, 50, 9900, 100, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-pp 0 .5 .0007 '(0 1 10 1 100 0) :r .999 :frequency 100 :amp-env-base 1000)
    {"NsyBass3", {0, 1, 500, 600, 0, 100, 7, 0, 50, 9990, 100, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-op 0 .2 .2 '(0 0 30 1 50 1 100 0) :b1 0.5)
    {"RattleP", {0, 0, 200, 200, 300, 500, 5, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                 5000, 1741, 20, 100}},
    // (subtract-oz 0 .2 .2 '(0 0 30 1 50 1 100 0) :a1 -0.5)
    {"RattleZ", {0, 2, 200, 200, 300, 500, 5, 0, -50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                 5000, 1741, 20, 100}},
    ...
    {"BlwBottl", {0, 1, 1000, 600, 0, 700, 7, 0, 50, 9999, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (subtract-pp 0 .4 .1 '(0 1 100 0) :r 0.7 :frequency 4000 :amp-env-base 1000000)
    {"FireCrkr", {0, 1, 400, 600, 0, 0, 10, 0, 50, 7000, 4000, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},

    // ---- Additive: drum-add.ins ----------------------------------------
    // (add-partials 0 .5 300 .5 steel-drum)   -- default amp-env (0 0 5 1 10 1 100 0)
    {"SteelDrm", {1, 0, 500, 500, 50, 100, 3, 0, 50, 9900, 300, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    ...
    {"ClockBel", {1, 0, 2000, 500, 0, 100, 1, 0, 50, 9900, 300, 49, 1400, 0, 100, 50, 1, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (add-partials 0 1 1300 .5 odd-chime :amp-env '(0 1 10 1 100 0))
    {"OddChime", {1, 0, 1000, 500, 0, 100, 3, 0, 50, 9900, 1300, 49, 1400, 0, 100, 50, 2, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (add-partials 0 1 1300 .5 even-chime :amp-env '(0 1 10 1 100 0))
    {"EvnChime", {1, 0, 1000, 500, 0, 100, 3, 0, 50, 9900, 1300, 49, 1400, 0, 100, 50, 3, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (add-freqs 0 2 .1 bell :amp-env '(0 1 10 1 100 0))   -- 16384-point FFT
    {"TubBell1", {1, 0, 2000, 500, 0, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 4, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (add-freqs 0 2 .1 bell ...)   -- 65536-point FFT, the page's favourite
    {"TubBell2", {1, 0, 2000, 500, 0, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 5, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (add-freqs 0 2 .1 bell ...)   -- 262144-point FFT
    {"TubBell3", {1, 0, 2000, 500, 0, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 6, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (add-freqs 0 1 .1 gong :amp-env '(0 0 1 1 10 1 100 0))
    {"SmallGng", {1, 0, 1000, 500, 10, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 7, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (add-freqs 0 1 .1 cymbal :amp-env '(0 1 10 1 100 0))   -- 262144-point FFT
    {"TurkCym1", {1, 0, 1000, 500, 0, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 8, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (add-freqs 0 1 .1 cymbal ...)   -- 16384-point FFT
    {"TurkCym2", {1, 0, 1000, 500, 0, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 9, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (add-noisy-freqs 0 1 .1 cymbal 1 :amp-env '(0 1 10 1 100 0))
    {"NsyTCym", {1, 2, 1000, 500, 0, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 8, 100, 1000, 0,
                 5000, 1741, 20, 100}},
    // (add-noise 0 .5 .0005 '(100 1 200 .5 400 .2) :amp-env '(0 0 1 1 10 1 100 0) :r .99)
    {"NsyBsDrm", {1, 3, 500, 500, 10, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 10, 100, 0, 0,
                  5000, 1741, 20, 100}},

    // ---- FM: drum-fm.ins -----------------------------------------------
    // (fm 0 10 1 200 1.4 :car-env '(0 1 50 .2 100 0) :mod-env '(0 1 50 .2 100 0) :mod-index2 1)
    {"ChwnBell", {2, 0, 10000, 1000, 0, 500, 3, 0, 50, 9900, 200, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (fm 0 .2 1 200 1.4 :car-env '(0 .8 20 1 50 .2 100 0) :mod-env '(0 1 12 0 100 0)
    //     :mod-index2 .2)
    {"WoodDrum", {2, 1, 200, 1000, 200, 500, 3, 0, 50, 9900, 200, 49, 1400, 0, 20, 12, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (fm 0 .2 1 200 0.6875 ...)   -- Ratio is thousandths, so 0.6875 stores as 0.688
    {"WoodDrm2", {2, 1, 200, 1000, 200, 500, 3, 0, 50, 9900, 200, 49, 688, 0, 20, 12, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (fm 0 1 .5 1000 2.005 :car-env '(0 1 50 .2 100 0) :mod-env '(0 1 25 .2 100 0) :mod-index2 1)
    {"MetlChim", {2, 0, 1000, 500, 0, 500, 3, 0, 50, 9900, 1000, 49, 2005, 0, 100, 25, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (fm 0 .2 1 400 2.4 :car-env '(0 0.8 10 1 50 .2 100 0) :mod-env '(0 1 50 .2 100 0)
    //     :mod-index2 .2)
    {"Marimba", {2, 0, 200, 1000, 100, 500, 3, 0, 50, 9900, 400, 49, 2400, 0, 20, 50, 0, 100, 0, 0,
                 5000, 1741, 20, 100}},
    // (fm 0 .5 5 50 1.4 :car-env '(0 .8 20 1 50 .2 100 0) :mod-env '(0 1 12 0 100 0)
    //     :mod-index2 .2)   -- amplitude 5 clamps to 100%
    {"DnceBas1", {2, 1, 500, 1000, 200, 500, 3, 0, 50, 9900, 50, 49, 1400, 0, 20, 12, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (fm i .4 5 80 0.6875 :car-env '(0 .8 20 1 50 .2 100 0) :mod-env '(0 1 12 0 100 0)
    //     :mod-index2 2.5)
    {"DnceBas2", {2, 1, 400, 1000, 200, 500, 3, 0, 50, 9900, 80, 49, 688, 0, 250, 12, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    ...
    {"FMBrshSn", {2, 0, 300, 500, 100, 500, 3, 0, 50, 9900, 200, 49, 1400, 200, 100, 50, 0, 100, 0,
                  0, 5000, 1741, 20, 100}},
    // (fm 0 1 1 40 2.2 :car-env '(0 .8 20 1 50 .2 100 0) :mod-env '(0 0 12 1 100 0) :mod-index2 2)
    {"ShetMetl", {2, 2, 1000, 1000, 200, 500, 3, 0, 50, 9900, 40, 49, 2200, 0, 200, 12, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    ...
    {"KSSnare1", {3, 0, 2000, 500, 0, 1000, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (drum-ks 0 .5 :p 1000 :b 0.6)
    {"KSSnare2", {3, 0, 2000, 500, 0, 1000, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  6000, 2177, 20, 100}},
    // (drum-ks 0 .5 :p 4000 :b 1 :amp-env '(0 1 90 1 100 0))
    {"KSCymbl1", {3, 0, 2000, 500, 0, 900, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  10000, 8707, 20, 100}},
    // (drum-ks 0 .5 :p 2000 :b 1 :amp-env '(0 1 80 0 100 0))
    // The envelope reaches zero at 80% of a 2 s duration, so Decay is 1600 ms.
    {"KSCymbl2", {3, 0, 1600, 500, 0, 0, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  10000, 4354, 20, 100}},
    // (drum-ks 0 .5 :p 100 :b .98 :amp-env '(0 1 90 1 100 0))
    {"MetPlnk1", {3, 0, 2000, 500, 0, 900, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  9800, 218, 20, 100}},
    // (drum-ks 0 .5 :p 20 :b .997)
    {"MetPlnk2", {3, 0, 2000, 500, 0, 1000, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  9970, 44, 20, 100}},
    // (drum-ks 0 .5 :p 50 :b .99)
    {"MetPlnk3", {3, 0, 2000, 500, 0, 1000, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  9900, 109, 20, 100}},
    // (drum-ks 0 .5 :p 150 :b .99 :amp-env '(0 1 90 1 100 0))
    {"MetPlnk4", {3, 0, 2000, 500, 0, 900, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  9900, 327, 20, 100}},
    // (drum-ks 0 .5 :p 25 :b 1)
    {"MetPlnk5", {3, 0, 2000, 500, 0, 1000, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  10000, 54, 20, 100}},
    // (drum-ks 0 .5 :p 40 :b 0 :amp-env '(0 1 90 1 100 0))
    {"Pluck1", {3, 0, 2000, 500, 0, 900, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                0, 87, 20, 100}},
    // (drum-ks 0 1 :p 25 :b 0)
    {"Pluck2", {3, 0, 2000, 1000, 0, 1000, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                0, 54, 20, 100}},
    // (drum-ks 0 .5 :p 200 :b 0 :amp-env '(0 1 50 1 100 0) :duration 2)
    {"Pluck3", {3, 0, 2000, 500, 0, 500, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                0, 435, 20, 100}},
    // (drum-ks 0 .5 :p 400 :b 0 :amp-env '(0 1 50 1 100 0) :duration 2)
    {"Pluck4", {3, 0, 2000, 500, 0, 500, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                0, 871, 20, 100}},
    ...
    {"BrknCym1", {4, 2, 2000, 500, 100, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (grani 0 4 5 "turkish-cymbal-1.snd" ... :grain-density 20 :reverse t)
    {"BrknCym2", {4, 3, 4000, 500, 100, 100, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 20, 100}},
    // (grani 0 2 10 "tubular-bell.snd" :grain-envelope '(0 1 100 0)
    //        :amp-envelope '(0 1 50 1 100 0) :grain-density 4 :reverse t)
    {"RhytBel1", {4, 1, 2000, 500, 0, 500, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 4, 100}},
    // (grani 2 2 10 "tubular-bell.snd" ... :grain-density 8 :reverse t)
    {"RhytBel2", {4, 0, 2000, 500, 0, 500, 3, 0, 50, 9900, 400, 49, 1400, 0, 100, 50, 0, 100, 0, 0,
                  5000, 1741, 8, 100}},
};
