...
int main(int argc, char** argv) {
    ...
    // Preset index, trigger note, render duration, name.
    // Index must match the array position in synth_engine.h m_factory_presets[].
    // TamTam was removed; all indices from 9 onward shifted down by 1.
