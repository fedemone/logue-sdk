...
SynthState state;
    ...
    inline void LoadPreset(uint8_t idx) {
        ...
        static const int32_t presets[k_NumPrograms][k_lastParamIndex] = {
            ...
            {  17,  79,   0,   1, 900, 480,   0,   0,   0,   2,   3,  -3,   0,   0,   1,   0,   1,   1,   0,  20, 260,   0, 800, 707},         // 17: Claves     — final Stage-1: InHm3 to reduce audible inharmonic beating while keeping wood attack
            ...
            {  30,  62,   0,   1, 600, 425,   0,   0,   1,   5, 148,   3,   0,   0,  10,   8,   2,   9,   0,  15, 520,   0, 710, 707},      // 30: Conga   — softer MlSt365 + TbRd9 + NzMx15/NzFq650 for tighter conga snap
