...
public:
    ...
    inline void LoadPreset(uint8_t idx) {
        ...
        //                            ÷10                           ÷10                                                              ÷10
            ...
            { 1,  72,   0,   1,   900,  380,  0,   0,     0, 6,  120,  -6,    0,   0,  4,    12,     1,   5,  12,    4, 450,  0,  1200, 707}, // 1:  Marimba    — Batch-1 percussive pass: shorter decay + harder mallet + small exciter noise for woody attack
            ...
            { 5,  40,   0,   1,   350,  420,  0,   0,     2, 5,  110,   2,    0,  22, 10,     5,     1,   5,   3,    8, 450,  0,   450, 707}, // 5:  Timpani    — Batch-1 percussive pass: less sustain, faster strike and stronger membrane/noise transient
            { 6,  48,   0,   1,   700,  430,  0,   0,     2, 5,   95,  -1,    0,  40, 10,    18,     3,   5,   5,   20, 520,  0,   550, 707}, // 6:  Djambe     — Batch-1 percussive pass: tighter decay, stronger attack transient, reduced string-like tail
            { 7,  41,   0,   1,   260,  320,  0,   0,     2, 5,  130,   6,    0,  35, 14,    28,     1,   5,   5,   12, 520,  0,   450, 707}, // 7:  Taiko      — Batch-1 percussive pass: reduced ring and higher transient content for a drum-head strike
            ...
            {12,  48,   0,   1,   900,  460,  0,   0,     0, 2,   70,   9,    0,   0,  2,    12,     1,   5,   0,   10, 420,  0,   650, 707}, // 12: Wodblk     — Batch-1 percussive pass: very fast decay + hard mallet for a short wooden click
            ...
            {31,  62,   0,   1,   700,  420,  0,   0,     1, 5,   95,   1,    0,   0,  9,     9,     2,   5,   0,   18, 560,  0,   900, 707},  // 31: Conga   — Batch-1 percussive pass: stronger onset and shorter body resonance
            ...
            {37,  57,   0,   1,   700,  480,  0,   0,     1, 5,   80,   2,    0,   0,  7,     7,     2,   5,   0,   10, 560,  0,   120, 707},  // 37: Bongo   — Batch-1 percussive pass: shorter ring, brighter initial knock, slightly higher noise transient
