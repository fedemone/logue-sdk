...
SynthState state;
    ...
    inline void LoadPreset(uint8_t idx) {
        ...
        static const int32_t presets[k_NumPrograms][k_lastParamIndex] = {
            ...
            {   6,  48,   0,   1, 600, 350,   0,   0,   1,   5, 162,  -2,   0,  35,  12,   8,   5,  15,   5,   7, 450,   0, 500, 707},      // 6:  Djambe     — Dkay102/Mterl0: drier djembe body with wider noise cutoff
            {   7,  41,   0,   1, 250, 390,   0,   0,   1,   5, 200,   8,   0,  30,  15,   1,   1,  11,   5,   9, 550,   0, 130, 707},       // 7:  Taiko      — harder mallet + reduced noise tail NzMx14 + lower NzFq for thud character
            ...
            {  16,  60,   0,   1, 600,   0,   0,   0,   0,   4, 200,  16,   0,   0,  12,   0,   3,   9,   5,   0, 300,   0,1000, 707},        // 16: StelPan    — Mterl14 brighter pan + TbRd11 for steelpan inharmonic partial spread
            {  17,  79,   0,   1, 900, 480,   0,   0,   0,   2,  23,  -5,   0,   0,   1,   0,   1,   1,   0,  20, 260,   0, 800, 707},         // 17: Claves     — final Stage-1: InHm3 to reduce audible inharmonic beating while keeping wood attack
            {  18,  67,   0,   1, 800, 420,   0,   0,   0,   4, 185,  18,   0,   0,   4,  28,  20,   3,  30,   5, 300,   0,1000, 707},   // 18: Cowbell    — Dkay:55→175 (~2s metallic ring); InHm:1700→200 (moderate plate inharmonicity)
            ...
            // ── New kit voices ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
            //  Prg  Nte  Bnk  Smp - MlRs MlSt VlRs VlSt - Ptls Mdl  Dky  Mtr - Ton  Hit  Rel  InHm - LwCt TbRd Gain NzMx - NzRs NzFl NzFq Rsnc
            {  28,  79,   0,   1, 900, 500,   0,   0,   0,   4, 160,  12,   0,   0,   2,  15,   5,   3,   0,  58, 920,   2, 900, 707},      // 28: HHat-C  — Mterl12 (from 26): centroid was 15-16kHz vs ref 7kHz; darker LP reduces KS harmonics above ~10kHz. softer mallet MlSt420 + InHm14 metallic partial spread + NzMx35/NzFq600. rescue pass: tighter short chick with brighter/sparser metallic top
            {  29,  79,   0,   1, 900, 490,   0,   0,   0,   4, 200,  18,   0,   0,  14,  12,   5,  12,   0,  79,1000,   2,1500, 707},  // 29: HHat-O  — brighter upper band and noise weighting
            {  30,  62,   0,   1, 600, 425,   0,   0,   1,   5, 168,   1,   0,   0,  10,   8,   2,   9,   0,  15, 520,   0, 710, 707},      // 30: Conga   — softer MlSt365 + TbRd9 + NzMx15/NzFq650 for tighter conga snap
            {  31,  62,   0,   1, 700, 300,   0,   0,   0,   4, 200,  20,   0,   0,  20,   0,   5,  18,   0,   5, 300,   0,1000, 707},     // 31: Handpn  — Mterl22/TbRd20 nitrided steel; coeff≈0.960→dc_gain≈0.996→T60≈1.58s measured; within [1.42,20.8]s test bounds
            ...
            {  37,  88,   0,   1, 100, 450,   0,   0,   0,   7, 200,   3,   0,   0,   5,   0,   2,  19,   0,  50, 110,   0, 390, 707},       // 37: GlsBotl — MlSt450 harder blow onset; Mterl5 brighter; NzMx45/NzRs150 short puff
            {  38,  49,   0,   1, 900, 500,   0,   0,   0,   4, 200,   5,   0,   0,   3,  14,   5,   1,   0,  24, 150,   2, 400, 707}       // 38: Tick    — InHm16 tight wood spread; NzMx24/NzRs150 crisp tick transient
        };
