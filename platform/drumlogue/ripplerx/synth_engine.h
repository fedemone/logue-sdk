...
SynthState state;
    ...
    inline void LoadPreset(uint8_t idx) {
        ...
        static const int32_t presets[k_NumPrograms][k_lastParamIndex] = {
            ...
            {   5,  40,   0,   1, 360, 300,   0,   0,   2,   3, 200,  -2,   0,  36,  18,  11,   0,  -4,   4,  16, 420,   0, 380, 707},    // 5:  Timpani    — InHm9: slight spread on coupled membrane mode; NzRs300 longer noise tail. rescue pass: deeper boom (darker loss) with longer low-body sustain and broader impact
