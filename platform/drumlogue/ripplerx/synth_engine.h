...
public:
    ...
    inline void LoadPreset(uint8_t idx) {
        ...
        //
        //                            ÷10                           ÷10                                                              ÷10
             {   0,  60,   0,   0, 500, 470,   0,   0,   0,   0,  35,  10,   0,   0,  10,   1,   1,   5,   0,   0, 300,   0,1200, 707}, // 0:  InitDbg    — pure KS string, no coupling
             {   1,  72,   0,   1, 800, 130,   0,   0,   0,   6, 194,  -7,   0,   0,   5,  17,   1,   9,  20,   0, 300,   0,1200, 707}, // 1:  Marimba    — sample: C5/1.0s→Dkay184; B=0.0075→InHm15; centroid→Mterl-9; Note60→72
             {   2,  36,   0,   0, 150,   0,   0,   0,   0,   3, 180,  -6,  -5,   0,  15,   1,   1,   5,   0,   0, 300,   0,1200, 707}, // 2:  808 Sub    — final Stage-1: Dkay170/Mterl-6 to counter LP-loss-shortened tail without adding noise
             {   3,  38,   0,   1, 400, 170,   0,   0,   2,   5,  65,  -4,   0,  50,   8,   1,   1,   9,   5,  40, 500,   2,  40, 707}, // 3:  Ac Snare   — Dkay35: shorter KS body shifts timbre to snappier snare vs metallic gong; NzMx35 raises noise floor
             {   4,  72,   0,   1, 900, 370,   0,   0,   0,   1, 200,  30,   0,   0,  20,   6,  20,  20,   0,  10, 380,   0,1500, 707}, // 4:  TblrBel    — c=0.98@524Hz (Mterl28+TubRad20); MlltStif100 (medium felt mallet, less overtone energy → measured T60 tracks fundamental ~7.5s)
             {   5,  40,   0,   1, 300, 320,   0,   0,   2,   3, 185,   1,   0,  30,  15,   8,   1,  -1,   3,   7, 260,   0, 680, 707}, // 5:  Timpani    — InHm9: slight spread on coupled membrane mode; NzRs300 longer noise tail
             {   6,  48,   0,   1, 600, 350,   0,   0,   1,   5, 112,   2,   0,  35,  12,  13,   5,  17,   5,  12, 450,   0, 380, 707}, // 6:  Djambe     — Dkay102/Mterl0: drier djembe body with wider noise cutoff
             {   7,  41,   0,   1, 250, 390,   0,   0,   1,   5, 180,   4,   0,  30,  15,   4,   1,   9,   5,  34, 590,   0, 370, 707}, // 7:  Taiko      — harder mallet + reduced noise tail NzMx14 + lower NzFq for thud character
             {   8,  65,   0,   1, 720, 500,   0,   0,   1,   5, 130,  20,   0,  50,   8,  15,  25,  21,   5,  20, 690,   2, 340, 707}, // 8:  MrchSnr    — Mterl12: less bright shell; NzMx20/NzFq400 for snappier wire character
             {   9,  60,   0,   1, 600, 335,   0,   0,   0,   0, 185,  12,   0,   0,  12,   3,   1,   9,   0,   5, 180,   0,1000, 707}, // 09: Koto       — InHm3 adds light inharmonic shimmer; no noise for cleaner pluck
             {  10,  72,   0,   1, 500, 300,   0,   0,   0,   1, 200,   2,   0,   0,  18,   2,   1,   6,   0,   0, 300,   0,1000, 707}, // 10: Vibrph     — final Stage-1: max Dkay + brighter loss profile (Mterl2/TubRad10) to offset LP-loss under-decay
             {  11,  48,   0,   1, 900, 500,   0,   0,   0,   2, 156,  24,   0,   0,   2,  12,   1,   5,   0,   5, 460,   0, 900, 707}, // 11: Wodblk     — NzMx5 light transient click; NzRs420 short burst
             {  12,  45,   0,   1, 400, 260,   0,   0,   2,   5, 150,   2,   0,  50,  10,   1,   1,   9,   5,   5, 300,   0, 680, 707}, // 12: Ac Tom     — softer mallet + InHm0 for cleaner membrane fundamental
             {  13,  60,   0,   1, 800, 480,   0,   0,   0,   4, 200,  24,   0,   0,  18,   8,   5,  11,   5,   8, 600,   2, 400, 707}, // 13: Cymbal     — Dkay182/Mterl16/InHm7: balanced metallic with 6-mode bank + diffuser + noise bed
             ...
             {  15,  65,   0,   1, 700, 461,   0,   0,   0,   1, 200,   6,   0,   0,   5,   7,   1,   1,   3,   5, 300,   0,1000, 707}, // 15: Kalimba    — Mterl10 warmer bar + InHm6 natural tine spread + TbRd7
             {  16,  60,   0,   1, 600,   0,   0,   0,   0,   4, 200,   8,   0,   0,  12,   1,   3,   3,   5,   0, 300,   0,1000, 707}, // 16: StelPan    — Mterl14 brighter pan + TbRd11 for steelpan inharmonic partial spread
             {  17,  79,   0,   1, 900, 500,   0,   0,   0,   2,  13,  -3,   0,   0,   1,   3,   1,   3,   0,   5, 300,   0, 800, 707}, // 17: Claves     — final Stage-1: InHm3 to reduce audible inharmonic beating while keeping wood attack
             {  18,  67,   0,   1, 800, 420,   0,   0,   0,   4, 185,  20,   0,   0,   4,  20,  20,   5,  30,   0, 300,   0,1000, 707}, // 18: Cowbell    — Dkay:55→175 (~2s metallic ring); InHm:1700→200 (moderate plate inharmonicity)
             {  19,  84,   0,   1, 900, 410,   0,   0,   0,   1, 190,   2,   0,   0,  15,  20,  80,  17,   0,   0, 300,   0,1500, 707}, // 19: Triangle   — harder mallet MlSt440 for cleaner metallic ping onset
             {  20,  36,   0,   1, 300,  80,   0,   0,   2,   5, 135,   3,   0,  50,   6,   3,   1,   5,   5,   8, 240,   0, 300, 707}, // 20: Kick Drum  — Dkay165/Mterl3: longer punch tail; softer MlSt110; NzMx8 subtle click layer
             {  21,  60,   0,   1, 500, 270,   0,   0,   2,   5,  15,   5,   0,  50,   3,   1,  10,   5,   5,  95, 600,   2, 600, 707}, // 21: Clap       — NzMx95: maximum noise content for hand-clap character
             {  22,  72,   0,   1, 100, 370,   0,   0,   2,   5,  52,  10,   0,  50,   2,   1,  20,   5,   3,  95, 940,   2, 860, 707}, // 22: Shaker     — Dkay12/Mterl10: dry rattle body; NzMx90 high noise content
             {  23,  72,   0,   1, 100, 102,   0,   0,   0,   7, 200,  -3,   0,   0,  12,   2,   1,   5,   0,  30, 990,   0, 340, 707}, // 23: Flute      — InHm0 pure tube; NzMx15 breath noise; NzFq400 4kHz breath shimmer
             {  24,  72,   0,   0,  50,   0,   0,   0,   0,   8, 195,  -4,   0,   0,  12,  11,   1,  11,   0,  18, 850,   0, 540, 707}, // 24: Clarinet   — Dkay185/Mterl-4: more even tube body; MlSt50 reed articulation; NzMx8 breath
             {  25,  36,   0,   1, 600, 250,   0,   0,   0,   0, 105,  -6,   0,   0,  10,   1,   1,   5,  40,   0, 300,   0, 500, 707}, // 25: PlkBass    — final Stage-1: less drive + harder mallet / slightly longer decay for cleaner pluck body
             {  26,  76,   0,   1, 700, 140,   0,   0,   0,   4, 200,  30,   0,   0,  18,  11,  10,  20,   0,  20, 300,   0,1200, 707}, // 26: GlsBwl     — InHm10 glass bowl partials; no noise for pure bowl character
             ...
             //  Prg  Nte  Bnk  Smp - MlRs MlSt VlRs VlSt - Ptls Mdl  Dky  Mtr - Ton  Hit  Rel  InHm - LwCt TbRd Gain NzMx - NzRs NzFl NzFq Rsnc
             {  27,  69,   0,   0, 800, 500,   0,   0,   0,   0, 200,  28,   0,   0,  15,   1,   1,  15,   0,   0, 300,   0,1200, 707},  // 28: Guitar String — KS reference, A4, T60≈3.3s
             // ── New kit voices ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
             //  Prg  Nte  Bnk  Smp - MlRs MlSt VlRs VlSt - Ptls Mdl  Dky  Mtr - Ton  Hit  Rel  InHm - LwCt TbRd Gain NzMx - NzRs NzFl NzFq Rsnc
             {  28,  79,   0,   1, 900, 420,   0,   0,   0,   4,  79,  30,   0,   0,   2,  15,   5,   5,   0,  35, 720,   2, 600, 707},  // 28: HHat-C  — softer mallet MlSt420 + InHm14 metallic partial spread + NzMx35/NzFq600
             {  29,  79,   0,   1, 900, 450,   0,   0,   0,   4, 169,  25,   0,   0,  15,  10,   5,  21,   0,  50,1000,   2, 720, 707},  // 29: HHat-O  — Mterl27/TbRd21: balanced open hat ring; NzMx45/NzFq600 sizzle
             {  30,  62,   0,   1, 600, 365,   0,   0,   1,   5, 158,   3,   0,   0,  10,  11,   2,  11,   0,  35, 600,   0, 650, 707},  // 30: Conga   — softer MlSt365 + TbRd9 + NzMx15/NzFq650 for tighter conga snap
             {  31,  62,   0,   1, 700, 300,   0,   0,   0,   4, 190,   7,   0,   0,  20,   1,   5,  17,   0,   5, 180,   0,1000, 707},  // 31: Handpn  — MlSt300 softer strike; Mterl7 warmer plate; InHm1 near-harmonic handpan
             {  32,  84,   0,   1, 900, 420,   0,   0,   0,   1, 200,  20,   0,   0,   8,  11,  10,   5,   0,   0, 300,   0,1200, 707},  // 32: BelTre  — Beam, T60=1.0s@C6→Dkay193; Mterl20 very bright; InHm10 metallic partial spread
             {  33,  60,   0,   1, 700, 270,   0,   0,   0,   6, 177,   8,   0,   0,  10,   7,   2,   5,   0,   0, 300,   0, 800, 707},  // 33: SltDrm  — MarBar, T60=1.0s@C4→Dkay167; Mterl8 mid-bright wood; InHm6 (B≈0.003)
             {  34,  57,   0,   1, 900, 500,   0,   0,   0,   4, 180,  30,   0,   0,  18,   4,   5,  19,   0,  10, 660,   2, 660, 707},  // 34: Ride    — InHm6 plate spread; NzMx15/NzRs700 sizzle-only noise character
             {  35,  60,   0,   1, 900, 500,   0,   0,   0,   4, 194,  18,   0,   0,   8,   8,   5,   3,   0,  15, 560,   2, 700, 707},  // 35: RidBel  — InHm10 bell spread; TbRd3; NzFq700 higher sizzle
             {  36,  57,   0,   1, 650, 350,   0,   0,   0,   5, 152,  -2,   0,   0,   8,   7,   2,   1,   0,  10, 520,   0, 570, 707},  // 36: Bongo   — harder mallet MlSt410 for sharper bongo slap; InHm6 tonal cue
             {  37,  88,   0,   1, 100, 450,   0,   0,   0,   7, 195,   5,   0,   0,   5,   2,   2,  15,   0,  40, 190,   0, 450, 707},  // 37: GlsBotl — MlSt450 harder blow onset; Mterl5 brighter; NzMx45/NzRs150 short puff
             {  38,  49,   0,   1, 900, 470,   0,   0,   0,   4, 140,  11,   0,   0,   3,  17,   5,   5,   0,  19,  70,   2, 400, 707}   // 38: Tick    — InHm16 tight wood spread; NzMx24/NzRs150 crisp tick transient
         };
