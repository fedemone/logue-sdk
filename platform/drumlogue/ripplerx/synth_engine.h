...
public:
    ...
    inline void LoadPreset(uint8_t idx) {
        ...
        //
        //                            ÷10                           ÷10                                                              ÷10
             {   0,  60,   0,   0, 500, 470,   0,   0,   0,   0,  35,  10,   0,   0,  10,   0,   1,   5,   0,   0, 300,   0,1200, 707}, // 0:  InitDbg    — pure KS string, no coupling
             {   1,  72,   0,   1, 800, 100,   0,   0,   0,   6, 194,  -7,   0,   0,   5,  15,   1,   9,  20,   0, 300,   0,1200, 707}, // 1:  Marimba    — sample: C5/1.0s→Dkay184; B=0.0075→InHm15; centroid→Mterl-9; Note60→72
             {   2,  36,   0,   0, 150,   0,   0,   0,   0,   3, 180,  -6,  -5,   0,  15,   0,   1,   5,   0,   0, 300,   0,1200, 707}, // 2:  808 Sub    — final Stage-1: Dkay170/Mterl-6 to counter LP-loss-shortened tail without adding noise
             {   3,  38,   0,   1, 400, 170,   0,   0,   2,   5,  25,  -4,   0,  50,   8,   0,   1,   5,   5,  40, 500,   2, 100, 707}, // 3:  Ac Snare   — Gain5 (was 10); NzMix40 (parallel noise now audible); HP@1kHz (was 8kHz)
             {   4,  72,   0,   1, 900, 310,   0,   0,   0,   1, 200,  30,   0,   0,  20,   5,  20,  20,   0,  10, 300,   0,1500, 707}, // 4:  TblrBel    — c=0.98@524Hz (Mterl28+TubRad20); MlltStif100 (medium felt mallet, less overtone energy → measured T60 tracks fundamental ~7.5s)
             {   5,  40,   0,   1, 300, 320,   0,   0,   2,   3, 185,   1,   0,  30,  15,   9,   1,  -1,   3,   2, 300,   0, 500, 707}, // 5:  Timpani    — Gain3 (was 10); NzMix2 (was 3)
             {   6,  48,   0,   1, 600, 350,   0,   0,   1,   5, 102,   0,   0,  35,  12,  10,   5,  17,   5,   7, 450,   0, 500, 707}, // 6:  Djambe     — Phase-26: stronger body mode + less noisy transient masking for first-batch resemblance
             {   7,  41,   0,   1, 250, 390,   0,   0,   1,   5, 180,   4,   0,  30,  15,   3,   1,   9,   5,  14, 550,   0, 250, 707}, // 7:  Taiko      — Phase-26: reduce low-f0 drift, increase attack noise/body balance, shorter controlled tail
             {   8,  65,   0,   1, 720, 490,   0,   0,   1,   5, 130,  12,   0,  50,   8,  15,  25,  21,   5,  25, 650,   2, 400, 707}, // 8:  MrchSnr    — Phase-30: longer snare body + brighter/noisier shell transient for remaining-batch alignment
             {   9,  60,   0,   1, 600, 335,   0,   0,   0,   0, 185,  14,   0,   0,  12,   3,   1,   9,   0,   5, 300,   0,1000, 707}, // 09: Koto       — c=0.98@262Hz (Mterl28+TubRad15); all harmonics T60≈2.2s (ref 3.47s; ratio≥0.63)
             {  10,  72,   0,   1, 500, 270,   0,   0,   0,   1, 200,   2,   0,   0,  18,   1,   1,   6,   0,   0, 300,   0,1000, 707}, // 10: Vibrph     — final Stage-1: max Dkay + brighter loss profile (Mterl2/TubRad10) to offset LP-loss under-decay
             {  11,  48,   0,   1, 900, 470,   0,   0,   0,   2, 156,  24,   0,   0,   2,  10,   1,   5,   0,  10, 420,   0, 900, 707}, // 11: Wodblk     — Phase-26: more tonal wood body, less broadband hiss, brighter but cleaner click
             {  12,  45,   0,   1, 400, 230,   0,   0,   2,   5, 150,   2,   0,  50,  10,   0,   1,   9,   5,   0, 300,   0, 800, 707}, // 12: Ac Tom     — Gain5 (was 15)
             {  13,  60,   0,   1, 800, 470,   0,   0,   0,   4, 196,  22,   0,   0,  18,   7,   5,  11,   5,   0, 600,   2, 400, 707}, // 13: Cymbal     — NzFq400=4kHz (was 200=2kHz): shifting noise from 2→4kHz raises centroid from ×0.34 toward ×0.65 vs reference
             {  14,  50,   0,   1, 200,  10,   0,   0,   0,   4, 190,  -8,   0,   0,  20,   7,   1,  19,  20,   9, 800,   0,  30, 707}, // 14: Gong       — NzFq30=300Hz (was 600=6kHz): 6kHz noise was pulling centroid 3× above reference; B=0.004→InHm8
             {  15,  65,   0,   1, 700, 461,   0,   0,   0,   1, 190,  12,   0,   0,   5,   6,   1,   7,   3,   5, 300,   0,1000, 707}, // 15: Kalimba    — c=0.98@392Hz (Mterl28+TubRad15); all harmonics T60≈3.2s (ref 3.80s; ratio≥0.84)
             {  16,  60,   0,   1, 600,   0,   0,   0,   0,   4, 200,  16,   0,   0,  12,   0,   3,  11,   5,   0, 300,   0,1000, 707}, // 16: StelPan    — c=0.98@262Hz (Mterl28+TubRad15); MlltStif150; T60≈4.8s (ref 5.39s; ratio≥0.89)
             {  17,  79,   0,   1, 900, 450,   0,   0,   0,   2,   3,  -1,   0,   0,   1,   2,   1,   3,   0,   5, 300,   0, 800, 707}, // 17: Claves     — final Stage-1: InHm3 to reduce audible inharmonic beating while keeping wood attack
             {  18,  67,   0,   1, 800, 420,   0,   0,   0,   4, 185,  20,   0,   0,   4, 200,  20,   5,  30,   0, 300,   0,1000, 707}, // 18: Cowbell    — Dkay:55→175 (~2s metallic ring); InHm:1700→200 (moderate plate inharmonicity)
             {  19,  84,   0,   1, 900, 470,   0,   0,   0,   1, 190,   2,   0,   0,  15,  58,  80,  17,   0,   0, 300,   0,1500, 707}, // 19: Triangle   — final Stage-1: Mterl2/TubRad15 maximize practical sustain at Dkay ceiling
             {  20,  36,   0,   1, 300,  90,   0,   0,   2,   5, 150,  -1,   0,  50,   6,   4,   1,   5,   5,   3, 200,   0, 300, 707}, // 20: Kick Drum  — final Stage-1: Dkay70/Mterl-3 to recover tail shortened by LP loss
             ...
             {  22,  72,   0,   1, 100, 370,   0,   0,   2,   5,  12,  10,   0,  50,   2,   0,  20,   5,   3, 100, 900,   2, 800, 707}, // 22: Shaker     — Gain3; LwCt20 (was 80); NzRes900 (was 300→~240ms noise); HP@8kHz
             {  23,  72,   0,   1, 100, 132,   0,   0,   0,   7, 200,  -3,   0,   0,  12,   0,   1,   5,   0,  15, 950,   0, 400, 707}, // 23: Flute      — sample: D5/1.53s→Dkay191; MlltStif162; NzMix10 subtle breath; NzRes950
             {  24,  72,   0,   0,  50,   0,   0,   0,   0,   8, 200, -10,   0,   0,  12,  10,   1,   9,   0,   8, 850,   0, 600, 707}, // 24: Clarinet   — final Stage-1: shorter Dkay and lower NzMix/NzRes to tame tube-model over-long sustain
             {  25,  36,   0,   1, 600, 250,   0,   0,   0,   0, 105,  -6,   0,   0,  10,   0,   1,   5,  40,   0, 300,   0, 500, 707}, // 25: PlkBass    — final Stage-1: less drive + harder mallet / slightly longer decay for cleaner pluck body
             {  26,  76,   0,   1, 700,  20,   0,   0,   0,   4, 200,  30,   0,   0,  18,  10,  10,  20,   0,   0, 300,   0,1200, 707}, // 26: GlsBwl     — c=0.98@659Hz (Mterl28+TubRad20); MlltStif50 (very soft rubber mallet, nearly pure fundamental → measured T60 tracks fundamental ~6.3s ≥ ref12.5s/2)
             ...
             //  Prg  Nte  Bnk  Smp - MlRs MlSt VlRs VlSt - Ptls Mdl  Dky  Mtr - Ton  Hit  Rel  InHm - LwCt TbRd Gain NzMx - NzRs NzFl NzFq Rsnc
             {  27,  69,   0,   0, 800, 500,   0,   0,   0,   0, 200,  28,   0,   0,  15,   0,   1,  15,   0,   0, 300,   0,1200, 707},  // 28: Guitar String — KS reference, A4, T60≈3.3s
             // ── New kit voices ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
             //  Prg  Nte  Bnk  Smp - MlRs MlSt VlRs VlSt - Ptls Mdl  Dky  Mtr - Ton  Hit  Rel  InHm - LwCt TbRd Gain NzMx - NzRs NzFl NzFq Rsnc
             {  28,  79,   0,   1, 900, 420,   0,   0,   0,   4, 119,  30,   0,   0,   2,  14,   5,   5,   0,  45, 600,   2, 600, 707},  // 28: HHat-C  — LwCt5 (was 20); NzMix50 (was 70); NzRes600 (was 200→longer noise burst)
             {  29,  79,   0,   1, 900, 420,   0,   0,   0,   4, 179,  27,   0,   0,  15,   9,   5,  21,   0,  50, 920,   2, 600, 707},  // 29: HHat-O  — LwCt5; NzMix40 (was 60); NzRes920 (was 200→~400ms noise for open hat)
             {  30,  62,   0,   1, 600, 365,   0,   0,   1,   5, 148,   3,   0,   0,  10,  10,   2,   9,   0,  20, 520,   0, 650, 707},  // 30: Conga   — Phase-26: tighter drum tail and slightly brighter membrane center
             {  31,  62,   0,   1, 700, 300,   0,   0,   0,   4, 190,   7,   0,   0,  20,   1,   5,  17,   0,   5, 300,   0,1000, 707},  // 31: Handpn  — Plate, T60≈10s@D4→Dkay198; InHm2 (B≈0.001, near-harmonic); warm metallic
             ...
             {  34,  57,   0,   1, 900, 470,   0,   0,   0,   4, 190,  30,   0,   0,  18,   6,   5,  19,   0,  20, 700,   2, 600, 707},  // 34: Ride    — c=0.98@370Hz (Mterl28+TubRad15); T60≈3.1s (ref 4.69s; ratio≥0.66)
             {  35,  60,   0,   1, 900, 461,   0,   0,   0,   4, 194,  16,   0,   0,   8,  10,   5,   3,   0,  25, 600,   2, 700, 707},  // 35: RidBel  — LwCt5 (was 20); NzMix20 (was 60); NzRes600
             {  36,  57,   0,   1, 650, 410,   0,   0,   0,   5, 152,  -4,   0,   0,   8,   6,   2,   1,   0,   4, 520,   0, 450, 707},  // 36: Bongo   — Phase-26: more stable fundamental cue and less sub-bass-biased transient
             {  37,  88,   0,   1, 100, 450,   0,   0,   0,   7, 195,   7,   0,   0,   5,   0,   2,  15,   0,  50, 150,   0, 450, 707},  // 37: GlsBotl — final Stage-1: reduced noise dominance (NzMix55/NzRes150/NzFq450) for cleaner bottle resonance
             {  38,  49,   0,   1, 900, 470,   0,   0,   0,   4, 140,  11,   0,   0,   3,  16,   5,   5,   0,  29, 150,   2, 400, 707}   // 38: Tick    — Dkay100: combined T60≈0.34s; wg T60=0.40s, master t_s=0.71s; ratio=0.64 vs ref 0.54s
         };
