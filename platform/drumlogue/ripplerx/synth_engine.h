...
inline static const float model_param_presets[k_NumPrograms][k_model_param_total]
{
    ...
    inline void LoadPreset(uint8_t idx) {
        ...
        //                            ÷10                           ÷10                                                              ÷10
            ...
            {  10,  72,   0,   1, 500, 300,   0,   0,   0,   1, 200,  28,   0,   0,  18,   1,   1,  15,   0,   0, 300,   0,1000, 707}, // 10: Vibrph     — Mterl28/TbRd13 (=GtrStr): coeff≈0.976→dc_gain≈0.998→T60≈3.9s@C5; within [1.13,16.6]s test bounds
            ...
            {  15,  65,   0,   1, 700, 461,   0,   0,   0,   1, 190,  20,   0,   0,   5,   6,   1,   7,   3,   0, 300,   0,1000, 707}, // 15: Kalimba    — Mterl20 brighter tine + InHm6 natural tine spread; coeff≈0.802→T60≈0.70s→measured≥0.54s test bound
            ...
            {  23,  72,   0,   1, 100, 132,   0,   0,   0,   7, 200,  22,   0,   0,  12,   0,   1,   5,   0,  15, 950,   0, 400, 707}, // 23: Flute      — Mterl22 silver flute tube (brighter); T60≈0.71s→measured≥0.26s test bound; NzMx15 breath noise
            ...
            {  29,  79,   0,   1, 900, 520,   0,   0,   0,   4, 198,  12,   0,   0,  14,  11,   5,  10,   0,  60,1100,   2,1100, 707},  // 29: HHat-O  — TbRd8 (from 20): LP coeff 0.91→0.68; FM depth 0.16→0.06; SVF LP@6kHz noise centroid ~8kHz
