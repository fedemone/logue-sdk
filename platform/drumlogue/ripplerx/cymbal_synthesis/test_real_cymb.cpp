...
int renderPreset(const char *path,
  ...
  const uint32_t frames = (uint32_t)(seconds * (float)kSampleRate + 0.5f);
...
int main() {
  ...
  { "real_cymb_crash.wav", realistic_cymbals::PRESET_CRASH, 1.0f, 0.95f, 0.00f, 0.18f, 0.12f, 0x43524153u },
  { "real_cymb_ride.wav", realistic_cymbals::PRESET_RIDE, 1.3f, 0.75f, 0.10f, 0.12f, 0.08f, 0x52494445u },
  { "real_cymb_splash.wav", realistic_cymbals::PRESET_SPLASH, 3.0f, 0.90f, 0.00f, 0.10f, 0.06f, 0x53504c41u },
  { "real_cymb_gong.wav", realistic_cymbals::PRESET_GONG, 3.8f, 0.85f, 0.00f, 0.25f, 0.18f, 0x474f4e47u }
  };
